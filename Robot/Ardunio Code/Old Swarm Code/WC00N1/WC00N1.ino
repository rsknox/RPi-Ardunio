/* Weapons Contoller Code for Nano 1
 *  
...
// 0 = Master (00) (Weapons Controller)
// 1 (01)   = Child of Master(00) (Flight Leader)
// 2-5 (011,021,031,041) = Children of (01) (Wingmen)
...
void setup(){
  myData.Xposition = 512;
  myData.Yposition = 509;
